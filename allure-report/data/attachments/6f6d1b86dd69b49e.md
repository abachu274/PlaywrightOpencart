...
```ts
  ...
  19 |         this.firstName=page.getByPlaceholder('First Name');
  20 |         this.lastName=page.getByPlaceholder('Last Name');
  21 |         this.email=page.getByPlaceholder('E-Mail');
  22 |         this.enterPassword=page.getByPlaceholder('Password');
  ...
  58 | 
> 59 |         await this.agreeCheckbox.check();
     |                                  ^ Error: locator.check: Target page, context or browser has been closed
  60 | 
  61 |     }
  62 | 
